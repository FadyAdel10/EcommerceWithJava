...
public class Main {
    public static void main(String[] args){
        ...
        //Creating customer
        Customer customer1 = new Customer(1,"Ahmed",3200);

        customer1.addProductToCart(mobileScratchCards,4); //42
        customer1.addProductToCart(biscuits,2); //25.6
        customer1.addProductToCart(tv,1);  //2000
        customer1.addProductToCart(cheese,3); //60.9 901.8
        customer1.checkout();
